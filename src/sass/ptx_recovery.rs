...
// Binary decode path removed. ptx_recovery is deprecated until cuobjdump-based recovery is implemented.
...
impl PtxRecoveryEngine {
    ...
    pub fn recover_all(&mut self) -> Result<PtxRecoveryResult, PtxRecoveryError> {
        ...
        // Binary decode path removed — ptx_recovery requires cuobjdump text-based parsing.
        // This codepath is deprecated and will be replaced with cuobjdump-based recovery.
        return Err(PtxRecoveryError::Disassembly(
            "Binary SASS decode has been removed. Use cuobjdump text-based parsing instead.".to_string()
        ));
    }
